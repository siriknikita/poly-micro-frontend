...
const renderAvailableServicesOptions = ({
  microservices,
  handleServiceChange,
}: {
...
export const TestsTab: React.FC = () => {
  ...
  const selectedServiceName =
    microservices.find((s) => s.id === selectedService)?.name ||
    'Select Service';
  ...
  return (
    <div className="p-4">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6">
        View and run tests for your microservices. Select a service to see its
        available tests.
      </p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <BoxedWrapper
          className="border border-gray-200 dark:border-gray-700 shadow-sm p-4"
          marginBottom={0}
        >
          ...
          <div className="relative mb-4">
            ...
            {isDropdownOpen &&
              renderAvailableServicesOptions({
                microservices,
                handleServiceChange,
              })}
          </div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            The selected service's tests will be discovered using pytest's
